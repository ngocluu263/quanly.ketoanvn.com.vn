...
<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="pickerAndCalendar.ascx.cs" Inherits="vpro.eshop.cpanel.Calendar.pickerAndCalendar" %>
...
<ComponentArt:Calendar ID="Calendar" ClientSideOnSelectionChanged="Calendar_OnSelectionChanged"
    ...
    DayCssClass="day" DayHeaderCssClass="dayheader" CalendarTitleCssClass="titledate"
