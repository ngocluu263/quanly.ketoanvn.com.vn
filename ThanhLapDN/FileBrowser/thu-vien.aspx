<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="thu-vien.aspx.cs" Inherits="ThanhLapDN.FileBrowser.thu_vien" %>
...
<head runat="server">
    ...
    <link href="/Scripts/FBrowser/plugins/fineuploader/fineuploader.css" rel="stylesheet" />
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <iz:FileManager ID="FileManager1" runat="server" Height="480" Width="570" ImagesFolder="~/FileBrowser/img/cmd"
                MainDirectory="~/File/ThuVien" 
                CustomThumbnailHandler="~/FileBrowser/IZWebFileManagerThumbnailHandler.ashx" 
                FileViewMode="Thumbnails" ClientOpenItemFunction="fileSelected"
                DefaultAccessMode="Delete">
