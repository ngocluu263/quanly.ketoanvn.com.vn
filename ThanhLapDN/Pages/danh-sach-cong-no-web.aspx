                ...
                <dx:ASPxGridView ID="ASPxGridView1_project" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="4" Caption="Tên khách hàng" 
                            FieldName="TEN_KHACHHANG" FixedStyle="Left" Width="150px">
                            <DataItemTemplate>
                                <%# Eval("TEN_KHACHHANG")%>
                            </DataItemTemplate>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="5" Caption="Thông tin liên hệ" 
                            FieldName="THONGTINLIENHE_KHACHHAN" FixedStyle="Left"
                            Width="150px">
                            <DataItemTemplate>
                                <%# Eval("THONGTINLIENHE_KHACHHAN")%>
                            </DataItemTemplate>
                            <Settings AllowHeaderFilter="True"/>
                            <CellStyle HorizontalAlign="Center"></CellStyle>
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn VisibleIndex="6" Caption="Nội dung" FixedStyle="Left"
                            FieldName="NOIDUNG" Width="100px">
                            <CellStyle HorizontalAlign="Center"></CellStyle>
                            <DataItemTemplate>
                                <%# Eval("NOIDUNG")%>
                            </DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="7" Caption="Tên domain" 
                            FieldName="TEN_DOMAIN" FixedStyle="Left" Width="100px">
                            <DataItemTemplate>
                                <%# Eval("TEN_DOMAIN")%>
                            </DataItemTemplate>
                        ...
                        <dx:GridViewDataTextColumn Caption="NVKD" FieldName="NVKD" FixedStyle="Left" 
