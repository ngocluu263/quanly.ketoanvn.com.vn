...
{
    public partial class popup_quy_trinh : System.Web.UI.Page
    {
        ...
        public int getGUserRecevice(int _status)
        {
            ...
            if (_type != 3)
            {
                ...
                {
                    case 1: i = 5;
                        liTitle.Text = "Nhân viên xử lý hồ sơ";
                        break;//Nhân viên Xử lý hồ sơ
                    case 2: i = 7;
                        liTitle.Text = "Nhân viên hành chánh";
                        break;//Nhân viên hành chánh
                    case 3: i = 6;
                        liTitle.Text = "Nhân viên giao nhận";
                        break;//Nhân viên giao nhận
                    case 4: i = 7;
                        liTitle.Text = "Nhân viên hành chánh";
                        break;//Nhân viên hành chánh
                    case 5: i = 6;
                        ...
                        break;//Nhân viên giao nhận
                    case 6: i = 8;
                        liTitle.Text = "Nhân viên nộp hồ sơ";
                        break;//Quản lý xử lý hồ sơ
                }
            }
            else
            {
                switch (_status)
                {
                    ...
                    case 4: i = 12;
                        liTitle.Text = "Nhân viên hành chánh";
                        break;//Nhân viên hành chánh - hành chánh
                    case 5: i = 6;
                        liTitle.Text = "Nhân viên giao nhận";
                        break;//Nhân viên giao nhận
                }
