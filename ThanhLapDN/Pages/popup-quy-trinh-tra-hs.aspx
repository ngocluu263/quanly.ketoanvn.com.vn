<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="popup-quy-trinh-tra-hs.aspx.cs" Inherits="ThanhLapDN.Pages.popup_quy_trinh_tra_hs" %>
...
<body>
    ...
    <div style="width:100%;">
        ...
        <asp:RadioButtonList ID="rdbStatus" runat="server" AutoPostBack="True" 
            ...
            <asp:ListItem Value="1" Text="Đã nhận GP (Không khắc dấu)" Selected="True"></asp:ListItem>
            <asp:ListItem Value="2" Text="Đã nhận GP (Có khắc dấu)"></asp:ListItem>
            <asp:ListItem Value="3" Text="Bị bổ sung hồ sơ"></asp:ListItem>
        </asp:RadioButtonList>
        <asp:TextBox ID="txtMST" runat="server" class="textbox1" placeholder="Mã số thuế (bắt buộc)" style="background-color: #FFFFA3;"></asp:TextBox>
