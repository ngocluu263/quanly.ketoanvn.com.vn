...
{
    public partial class popup_quy_trinh_tra_hs_ketoan : System.Web.UI.Page
    {
        ...
        private void Save_Employ()
        {
            ...
            if (EmpSelected.Count > 0)
            {
                foreach (var i in EmpSelected)
                {
                    ...
                    db.SubmitChanges();
                    SendEmail(Utils.CIntDef(i.Value), _type, "Giai đoạn 2: Soạn hồ sơ");
                }
            }
            else
            {
        ...
        {
            var list = db.USERs.Where(n => (n.GROUP_ID == 11 || n.GROUP_ID == 12 || n.GROUP_ID == 13));
        ...
        protected void rdbStatus_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                liNote.Text = "";
                ListUser.Visible = txtTitleFile.Visible = FileUpload1.Visible = iUs.Visible = txtNote.Visible = true;
            }
            else
            {
                if (rdbStatus.SelectedValue == "5")
                {
                ...
                else
                {
                    ...
                    liNote.Text = "<p>" + rdbStatus.SelectedItem + "</p>";
                }
