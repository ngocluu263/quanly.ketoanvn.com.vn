<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-bien-ban-thanh-ly-hop-dong.aspx.cs" Inherits="ThanhLapDN.Pages.danh_sach_bien_ban_thanh_ly_hop_dong" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    <div id="header">
        ...
        <div class="toolbar" style="margin-left: 1006px; margin-top: -38px;">
            &nbsp;<asp:LinkButton ID="lbtnCapNhapCongNo" runat="server" class="k-button" ToolTip="Cập nhật trạng thái vào bảng công nợ" OnClientClick="return confirm('Bạn có muốn cập nhật thông tin những hợp đồng này vào công nợ kế toán? Hệ thống chỉ cập nhật mã số thuế chưa tồn tại trong công nợ và trạng thái đã hoàn thành!');"
                onclick="lbtnCapNhapCongNo_Click">
                <img alt="Cập nhật trạng thái" src="../Images/update-icon.png" /></asp:LinkButton>
            &nbsp;<a href="hop-dong-ke-toan.aspx" title="Tạo hợp đồng" class="k-button">
            ...
            <td>
                <dx:ASPxGridView ID="ASPxGridView1_project" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <dx:GridViewDataTextColumn VisibleIndex="1" Caption="Ngày hợp đồng" 
                            FieldName="MER_POS03" Width="120px">
                            <DataItemTemplate>
                                <%# Eval("MER_POS03")%>/<%# Eval("MER_POS04")%>/<%# Eval("MER_POS05")%></DataItemTemplate>
    ...
    <script type="text/javascript">
        function openTrangThai(id, status) {
            emailwindow = dhtmlmodal.open('EmailBox', 'iframe', '/Pages/popup-trang-thai-hop-dong-thanh-ly.aspx?id=' + id + '&status=' + status + '', 'Cập nhật trạng thái', 'width=350px,height=270px,center=1,resize=1,scrolling=1');
        }
    </script>
    <!--End Popup-->
</asp:Content>