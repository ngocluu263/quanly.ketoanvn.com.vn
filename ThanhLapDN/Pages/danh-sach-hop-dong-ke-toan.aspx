<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="danh-sach-hop-dong-ke-toan.aspx.cs" Inherits="ThanhLapDN.Pages.danh_sach_hop_dong_ke_toan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    ...
    <script type="text/javascript">
        function openTrangThai(id, status) {
            emailwindow = dhtmlmodal.open('EmailBox', 'iframe', '/Pages/popup-trang-thai-hop-dong.aspx?id=' + id + '&status=' + status + '', 'Cập nhật trạng thái', 'width=350px,height=270px,center=1,resize=1,scrolling=1');
        }
    </script>
    <!--End Popup-->
</asp:Content>