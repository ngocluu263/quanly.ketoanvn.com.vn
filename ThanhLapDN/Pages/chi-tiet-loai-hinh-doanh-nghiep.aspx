<%@ Page Title="" Language="C#" MasterPageFile="~/Master/Master.Master" AutoEventWireup="true" CodeBehind="chi-tiet-loai-hinh-doanh-nghiep.aspx.cs" Inherits="ThanhLapDN.Pages.chi_tiet_loai_hinh_doanh_nghiep" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMain" runat="server">
    ...
    <div id="header" style="padding-bottom: 5px;">
        <div class="title">
            Chi Tiết Loại hình doanh nghiệp
        </div>
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="3">
                                        <tr>
                                            <td class="td_left" align="right" valign="top" nowrap="nowrap">
                                                <span style="color: Red;">*</span>&nbsp;Tên loại hình cha
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                                <asp:DropDownList ID="Drmenu_parent" runat="server" 
                                                    CssClass="k-textbox textbox" AutoPostBack="True" 
                                                    OnSelectedIndexChanged="Drmenu_parent_SelectedIndexChanged">
                                                </asp:DropDownList>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="td_left" align="right" valign="top" nowrap="nowrap">
                                                <span style="color: Red;">*</span>&nbsp;Tên loại hình
                                            </td>
                                            <td align="left" nowrap="nowrap">
                                        ...
                                        <tr id="iTypeReg" runat="server">
                                            <td class="td_left" align="right" valign="top" nowrap="nowrap">
                                                Loại
                                            </td>
                                            <td align="left">
                                                <asp:RadioButtonList ID="rdbTypeReg" runat="server" RepeatColumns="5">
                                                    <asp:ListItem Text="Đăng ký" Value="1"></asp:ListItem>
                                                    <asp:ListItem Text="Thay đổi" Value="2" Selected="True"></asp:ListItem>
                                                </asp:RadioButtonList>
                                            </td>
                                        </tr>
                                        <tr>
