...
{
    public partial class danh_sach_phu_luc_gia_han : System.Web.UI.Page
    {
        #region Declare
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ASPxGridView1_project.DataSource = HttpContext.Current.Session["listPhuLucGiaHan"];
        ...
        private void LoadProject()
        {
            try
            {
                ...
                {
                    var list = _MerPhuLucGiaHanData.GetListAll()
                    ...
                    HttpContext.Current.Session["listPhuLucGiaHan"] = list;
        ...
        private void TestPermission()
        {
            ...
            {
                ASPxGridView1_project.Columns[8].Visible = false;
        ...
        public string getlink(object id)
        {
            ...
            {
                return Utils.CIntDef(id) > 0 ? "phu-luc-gia-han-hop-dong-ke-toan.aspx?id=" + Utils.CIntDef(id) : "phu-luc-gia-han-hop-dong-ke-toan.aspx";
            }
            else {
                return "danh-sach-phu-luc-gia-han.aspx"; 
            }
        }
        ...
        {
            string path = System.Configuration.ConfigurationManager.AppSettings["URLWebsite"] + "/File/WordFile/PhuLucGiaHanDVKT/PhuLucGiaHanDVKeToan_Code_" + Utils.CStrDef(obj_id) + ".docx";
            return path;
        }
        ...
        protected void lbtnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (Utils.CStrDef(Session["Grouptype"]) == "1" || Utils.CStrDef(Session["Grouptype"]) == "2")
            {
                ...
                {
                    _MerPhuLucGiaHanData.Remove(Utils.CIntDef(item));
                    string pathfileOld = Server.MapPath("/File/WordFile/PhuLucGiaHanDVKT/PhuLucGiaHanDVKeToan_Code_" + Utils.CStrDef(item) + ".docx");
            ...
            else
            {
                ...
                strScript += "window.location='danh-sach-phu-luc-gia-han.aspx';";
                strScript += "</script>";
